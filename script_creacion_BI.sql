...
-- Lo toma bien pero te hace el top 3 en general y lo requerimos que sea para los meses solamente 
SELECT TOP 3 c1.fecha, c1.idProducto, 
(SELECT SUM(c2.cantidad) FROM [DATA4MIND].[BI_hechos_compra] c2 WHERE c1.idProducto=c2.idProducto AND c1.fecha=c2.fecha) Cantidad_Total 
